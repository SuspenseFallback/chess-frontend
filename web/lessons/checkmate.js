...
var index = 0;
var text = [
  "Checkmate is a special case of stalemate, where the one side is under check and has no legal moves.",
  "Checkmate marks the end of the game, where the side in checkmate loses.",
  "Checkmate can happen during any phase of the game - opening, middlegame, or endgame.",
